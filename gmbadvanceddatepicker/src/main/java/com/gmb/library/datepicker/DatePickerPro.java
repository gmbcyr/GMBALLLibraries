package com.gmb.library.datepicker;
...
import com.gmb.gmbadvanceddatepicker.R;
import com.gmb.library.datepicker.tools.MyDatePickGestureListnerInterface;
...
public class DatePickerPro extends AlertDialog implements View.OnClickListener,Spinner.OnItemSelectedListener
    ...
    private TextView txtCurrentMonth,txtDayWeek,txtMonth,txtDayMonth,txtYear,txtNextMonth;
    private ImageView cmdPrevMonth;
    private ImageView cmdNextMonth;
    private GridView gridCalendarView;
    private GridCellAdapter adapter;
    private Spinner cmbDate;
    ...
    public DatePickerPro(Context context, DatePickerPro.OnDatePickedListener listener, int year,
        ...
        setView(initView(listener,dateOverdueAllowed));
    ...
    public View initView(DatePickerPro.OnDatePickedListener listener, boolean dateOverdueAllowed ) {
        ...
        ArrayAdapter<Integer> dataAdapter = new ArrayAdapter<Integer>(getContext(), android.R.layout.simple_spinner_item,listYear );
...
// Initialised
    ...
    private void setField(long newDate){
        ...
        txtMonth.setText(daF.format(calen.getTime()));
    ...
    private void setGridCellAdapterToDate(long timeParam) {
        ...
        timeParam=checkIfOverdueAllowed(timeParam);
    ...
    public void onClick(View v) {
        ...
        dateCour=checkIfOverdueAllowed(dateCour);
    ...
    private long checkIfOverdueAllowed(long newDate){

        dateCour=newDate;
        if(!acceptOverdue){

            if(dateCour<System.currentTimeMillis()){
